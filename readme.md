...
<div style="text-align: left;">
  <img src="sample_data/imgs/transformer_kv_cache.png" width="300" alt="Transformer KV Cache">
</div>
...
### 📉 Pareto Frontier
![Pareto Frontier](sample_data/plots/pareto_frontier_overlay.png)

### 🧩 Jointplot: Token Accuracy vs Validation Loss
![TokenAcc vs ValLoss](sample_data/plots/jointplot_tokenacc_valloss.png)

### 📈 Regression Residuals
![Regression Residuals](sample_data/plots/regression_residuals.png)

### 🧠 Validation Loss vs Embed Size (by Activation)
![Val Loss vs Embed Size](sample_data/plots/val_loss_vs_embed_size_by_activation.png)

### 📉 Perplexity vs Accuracy (Log Scale)
![Perplexity vs Accuracy](sample_data/plots/perplexity_vs_accuracy_log.png)

### 📦 Validation Loss by Activation (Ordered)
![Val Loss by Activation](sample_data/plots/val_loss_by_activation_ordered.png)

### 🔥 Heatmap – KGramMLPSeqModel
![Heatmap KGramMLP](sample_data/plots/val_loss_heatmap_kgram_mlp_seq_embed_k.png)

### 🔥 Heatmap – LSTMSeqModel
![Heatmap LSTM](sample_data/plots/val_loss_heatmap_lstm_seq_embed_k.png)

### 🔥 Heatmap – TransformerModel
![Heatmap Transformer](sample_data/plots/val_loss_heatmap_kvcache_transformer_embed_k.png)

### 📊 Correlation Matrix
![Correlation Matrix](sample_data/plots/correlation_matrix.png)
