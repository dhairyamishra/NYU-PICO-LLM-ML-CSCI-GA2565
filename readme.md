...
### 📉 Pareto Frontier
![Pareto Frontier](docs/plots/pareto_frontier_overlay.png)

### 🧩 Jointplot: Token Accuracy vs Validation Loss
![TokenAcc vs ValLoss](docs/plots/jointplot_tokenacc_valloss.png)

### 📈 Regression Residuals
![Regression Residuals](docs/plots/regression_residuals.png)

### 🧠 Validation Loss vs Embed Size (by Activation)
![Val Loss vs Embed Size](docs/plots/val_loss_vs_embed_size_by_activation.png)

### 📉 Perplexity vs Accuracy (Log Scale)
![Perplexity vs Accuracy](docs/plots/perplexity_vs_accuracy_log.png)

### 📦 Validation Loss by Activation (Ordered)
![Val Loss by Activation](docs/plots/val_loss_by_activation_ordered.png)

### 🔥 Heatmap – KGramMLPSeqModel
![Heatmap KGramMLP](docs/plots/val_loss_heatmap_KGramMLPSeqModel_embed_k.png)

### 🔥 Heatmap – LSTMSeqModel
![Heatmap LSTM](docs/plots/val_loss_heatmap_LSTMSeqModel_embed_k.png)

### 🔥 Heatmap – TransformerModel
![Heatmap Transformer](docs/plots/val_loss_heatmap_TransformerModel_embed_k.png)

### 📊 Correlation Matrix
![Correlation Matrix](docs/plots/correlation_matrix.png)
