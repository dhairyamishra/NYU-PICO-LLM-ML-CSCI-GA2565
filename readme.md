...
<div style="text-align: left;">
  <img src="docs/imgs/transformer_kv_cache.png" width="300" alt="Transformer KV Cache">
</div>
...
Here are recent plots automatically generated by `total_summary_analysis.py`:

## 📊 Analysis Visualizations

### 📉 Pareto Frontier
![Pareto Frontier](analysis_runs/plots/pareto_frontier_overlay.png)

### 🧩 Jointplot: Token Accuracy vs Validation Loss
![TokenAcc vs ValLoss](analysis_runs/plots/jointplot_tokenacc_valloss.png)

### 📈 Regression Residuals
![Regression Residuals](analysis_runs/plots/regression_residuals.png)

### 🧠 Validation Loss vs Embed Size (by Activation)
![Val Loss vs Embed Size](analysis_runs/plots/val_loss_vs_embed_size_by_activation.png)

### 📉 Perplexity vs Accuracy (Log Scale)
![Perplexity vs Accuracy](analysis_runs/plots/perplexity_vs_accuracy_log.png)

### 📦 Validation Loss by Activation (Ordered)
![Val Loss by Activation](analysis_runs/plots/val_loss_by_activation_ordered.png)

### 🔥 Heatmap – KGramMLPSeqModel
![Heatmap KGramMLP](analysis_runs/plots/val_loss_heatmap_KGramMLPSeqModel_embed_k.png)

### 🔥 Heatmap – LSTMSeqModel
![Heatmap LSTM](analysis_runs/plots/val_loss_heatmap_LSTMSeqModel_embed_k.png)

### 🔥 Heatmap – TransformerModel
![Heatmap Transformer](analysis_runs/plots/val_loss_heatmap_TransformerModel_embed_k.png)

### 📊 Correlation Matrix
![Correlation Matrix](analysis_runs/plots/correlation_matrix.png)
